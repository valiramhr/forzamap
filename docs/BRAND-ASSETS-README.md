...
Files: `favicon.ico` (multi-res 16/32/48), `favicon.svg`, `favicon-16.png`, `favicon-32.png`, `favicon-48.png`,
...
1. Have a type designer redraw the outlines as true Bézier curves — the current
...
2. Add Pantone equivalents for Ink and Forza once a print partner is chosen.
3. Register `forzamap` handles and clear the name in the target territory.
